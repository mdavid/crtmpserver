...
${OBJECTDIR}/_ext/674965218/sparsebuffer.o: ../../../../sources/common/src/utils/misc/sparsebuffer.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/674965218
	${RM} $@.d
	$(COMPILE.cc) -O2 -DOSX -DUSE_MEM_POOL -DDEBUG_MEM_POOL -DLITTLE_ENDIAN_SHORT_ALIGNED -DHAS_LUA -I/opt/local/include -I../../../../sources/common/include -I/opt/local/include/libxml2 -fPIC  -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/674965218/sparsebuffer.o ../../../../sources/common/src/utils/misc/sparsebuffer.cpp
